...
BEGIN {
    ...
    require 'C:/Users/Jesse/source/repos/SNPJuice/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Users/Jesse/source/repos/SNPJuice/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/test/fips-and-base.cnf';
    shift;
