...
static BOOL __stdcall spi_lock_game_list(DWORD, DWORD, AdFile** out_game_list) {
...
static BOOL __stdcall spi_unlock_game_list(AdFile* game_list, DWORD* list_count) {
...
static BOOL __stdcall spi_get_game_info(DWORD index, const char* game_name, const char* password, AdFile* out_game) {
...
static BOOL __stdcall spi_select_game(
    ...
    // This function is used for battle.net only to open its lobbies list and select or create a game
    return false;
}
