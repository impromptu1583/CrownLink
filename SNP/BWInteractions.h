...
inline const StormStdCall<
    b32(char* gamename, char* password, char* description, u32 category_bits, void* ldesc, u32 ld_size, void* initdata,
        u32 initdata_size, u32 max_players, char* player_name, char* player_description, DWORD* playerid)>
...
BW_REF(StormList<DirEntryMap>, g_dir_listing, 0x0051a278);
...
// builds directory listing (stormlist) for current directory. map info is not loaded (see below)
...
// loads map info for the selected map into the mapinfo struct
...
typedef BOOL(__stdcall* BW_CreateGameProc)();
inline BW_CreateGameProc bw_create_game = (BW_CreateGameProc)0x004a8050;
